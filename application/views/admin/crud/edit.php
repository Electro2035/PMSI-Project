...
<head>
    <meta charset="utf-8">
    <title>Edit Data Laundry - E-Laundry</title>
...
<body>
    <div class="container mt-5">
        ...
        <form action="<?= base_url('admin/crud_update/' . $laundry->id) ?>" method="post">
            <input type="hidden" name="id" value="<?= htmlspecialchars($laundry->id) ?>">

            <div class="mb-3">
                <label for="nama" class="form-label">Nama Laundry</label>
                <input type="text" class="form-control" id="nama" name="nama" value="<?= htmlspecialchars($laundry->nama) ?>" required>
            </div>
            <div class="mb-3">
                <label for="deskripsi" class="form-label">Deskripsi Singkat</label>
                <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3"><?= htmlspecialchars($laundry->deskripsi) ?></textarea>
            </div>
            <div class="mb-3">
                <label for="layanan" class="form-label">Layanan</label>
                <input type="text" class="form-control" id="layanan" name="layanan" value="<?= htmlspecialchars($laundry->layanan) ?>">
            </div>
            <div class="mb-3">
                <label for="harga" class="form-label">Harga Laundry (Rp)</label>
                <input type="number" class="form-control" id="harga" name="harga" value="<?= htmlspecialchars($laundry->harga) ?>">
            </div>
            <div class="mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <textarea class="form-control" id="alamat" name="alamat" rows="2"><?= htmlspecialchars($laundry->alamat) ?></textarea>
            </div>
            <div class="mb-3">
                <label for="jam_buka" class="form-label">Jam Buka</label>
                <input type="text" class="form-control" id="jam_buka" name="jam_buka" value="<?= htmlspecialchars($laundry->jam_buka) ?>">
            </div>
            <div class="mb-3">
                <label for="no_telp" class="form-label">Nomor Telepon</label>
                <input type="text" class="form-control" id="no_telp" name="no_telp" value="<?= htmlspecialchars($laundry->no_telp) ?>">
            </div>
            <div class="mb-3">
